 ...
 * of Hanoi.  It contains the three ring towers.  It also plays the game.
...
public class Board implements Runnable {
    ...
    /** The array of pegs. */
    private final Peg[] thePegs = new Peg[3];
...
// Insert solution to programming project 5, chapter -1 here
    ...
    /**
     * Initialized is set true when the board is constructed
