...
public abstract class AbstractGraph implements Graph {
     ...
     * is the weight.
     * @param scan The scanner containing the data
     */
// Insert solution to programming exercise 1, section 3, chapter 10 here
     ...
     *                                  "List", nor "Set".
     */
    static Graph createGraph(Scanner scan,
            boolean isDirected,
            String type) {
        ...
        switch (type) {
            ...
            case "list" :
                ...
                break;
            case "map" :
                returnValue = new MapGraph(numV, isDirected);
                break;
            default:
